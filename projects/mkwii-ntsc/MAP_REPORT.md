...
- Output map: `/Users/rookie/mkwiimac/wiicompiled/projects/mkwii-ntsc/MAP.txt` with **29265** entries (19943 named); `/Users/rookie/mkwiimac/wiicompiled/projects/mkwii-ntsc/region_port.json` carries the chunk table.
...
| REFERENCED | 12792 | 0 | 3318 | 9474 | yes |
| PLAUSIBLE | 4507 | 0 | 848 | 3659 | yes |
| IDENTITY | 15 | 15 | 0 | 0 | yes |
| INTERPOLATED | 0 | 0 | 0 | 0 | yes |
| TERTIARY | 0 | 0 | 0 | 0 | yes |
| UNVERIFIED | 207 | 0 | 125 | 82 | no |
| DROPPED | 320 | 0 | 162 | 158 | no |
| total | 29792 | 15 | 10980 | 18797 |  |

Emitted after deduplication: PROVEN=11951, REFERENCED=12792, PLAUSIBLE=4507, IDENTITY=15, INTERPOLATED=0, TERTIARY=0; total 29265. UNVERIFIED and DROPPED entries are never written to MAP.txt.

First-instruction quality of emitted entries (strong = typical prologue/first instruction, valid = any decodable instruction): IDENTITY/n/a=15, PLAUSIBLE/strong=4231, PLAUSIBLE/valid=276, PROVEN/strong=11759, PROVEN/valid=192, REFERENCED/strong=12723, REFERENCED/valid=69
...
|---|---|---|---|---|---|---|---|---|---|
| case | 2334 | 1 | 2332 | 1 | 0 | 0 | 0 | 0 | 0 |
| switch | 204 | 6 | 2 | 196 | 0 | 0 | 0 | 0 | 0 |
...
- REL (our verdict / tertiary verdict) pairs: DROPPED/UNVERIFIED=1, PLAUSIBLE/PLAUSIBLE=6, PLAUSIBLE/PROVEN=3, PLAUSIBLE/REFERENCED=6, PLAUSIBLE/UNVERIFIED=372, PROVEN/PLAUSIBLE=10, PROVEN/PROVEN=30, PROVEN/REFERENCED=15, PROVEN/UNVERIFIED=982, REFERENCED/PLAUSIBLE=46, REFERENCED/PROVEN=14, REFERENCED/REFERENCED=65, REFERENCED/UNVERIFIED=2201, UNVERIFIED/UNVERIFIED=1
...
- conditional-branch target that is also jump-table referenced (a case label without a label name): 39
...
| 8071b7ec | Audio::SoundTriggerMgr::ApplyTrigger_case2D_1 | 80713920 | ptr+b+bc | conditional-branch target (inside a function); prev=4bfe431d (bl) word=9abd0012 (op38) |
